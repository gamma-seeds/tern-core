#!/usr/bin/env python3
"""
bench_dsr1_7b_phase2.py — Apple brief benchmark for DeepSeek-R1 Distil 7B ternary on M4 Pro.
...
MODEL_PATH = Path(
    "/Users/syn/synapticode/models/coreml/dsr1-7b"
    "/dsr1_7b_ternary_v0.1.0.mlpackage"
)
PALETTISED_PATH = Path(
    "/Users/syn/synapticode/models/coreml/dsr1-7b"
    "/dsr1_7b_ternary_v0.1.0_2bit.mlpackage"
)
RESULTS_PATH = Path(__file__).parent / "dsr1_7b_phase2.json"
...
def main() -> int:
    ...
    try:
        ...
        # ── summary ──
        print(f"\n{'='*72}", flush=True)
        print("  RESULTS — DeepSeek-R1 7B Ternary (Apple Brief)", flush=True)
        print(f"{'='*72}", flush=True)
