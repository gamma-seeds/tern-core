#!/usr/bin/env python3
"""
bench_phi4_14b_phase2.py — Apple brief benchmark for Phi-4 14B ternary on M4 Pro.
...
def main() -> int:
    ...
    try:
        # ── spec ──
        print("=" * 72, flush=True)
        print("  Phi-4 14B Ternary — Apple Brief Benchmark", flush=True)
        print("=" * 72, flush=True)
        ...
        # ── summary ──
        print(f"\n{'='*72}", flush=True)
        print("  RESULTS — Phi-4 14B Ternary (Apple Brief)", flush=True)
        print(f"{'='*72}", flush=True)
