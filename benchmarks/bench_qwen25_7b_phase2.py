#!/usr/bin/env python3
"""
bench_qwen25_7b_phase2.py — Apple brief benchmark for Qwen2.5 7B ternary on M4 Pro.
...
MODEL_PATH = Path(
    "/Users/syn/synapticode/models/coreml/qwen25-7b"
    "/qwen25_7b_ternary_v0.1.0.mlpackage"
)
PALETTISED_PATH = Path(
    "/Users/syn/synapticode/models/coreml/qwen25-7b"
    "/qwen25_7b_ternary_v0.1.0_2bit.mlpackage"
)
RESULTS_PATH = Path(__file__).parent / "qwen25_7b_phase2.json"
...
def main() -> int:
    ...
    try:
        # ── spec ──
        print("=" * 72, flush=True)
        print("  Qwen2.5 7B Ternary — Apple Brief Benchmark", flush=True)
        print("=" * 72, flush=True)
        ...
        # ── summary ──
        print(f"\n{'='*72}", flush=True)
        print("  RESULTS — Qwen2.5 7B Ternary (Apple Brief)", flush=True)
        print(f"{'='*72}", flush=True)
