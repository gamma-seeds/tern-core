#!/usr/bin/env python3
"""
bench_gemma3_12b_phase2.py — Apple brief benchmark for Gemma 3 12B ternary on M4 Pro.
...
MODEL_PATH = Path(
    "/Users/syn/synapticode/models/coreml/gemma3-12b"
    "/gemma3_12b_ternary_v0.1.0.mlpackage"
)
PALETTISED_PATH = Path(
    "/Users/syn/synapticode/models/coreml/gemma3-12b"
    "/gemma3_12b_ternary_v0.1.0_2bit.mlpackage"
)
RESULTS_PATH = Path(__file__).parent / "gemma3_12b_phase2.json"
...
def main() -> int:
    ...
    try:
        # ── spec ──
        print("=" * 72, flush=True)
        print("  Gemma 3 12B Ternary — Apple Brief Benchmark", flush=True)
        print("=" * 72, flush=True)
        ...
        # ── summary ──
        print(f"\n{'='*72}", flush=True)
        print("  RESULTS — Gemma 3 12B Ternary (Apple Brief)", flush=True)
        print(f"{'='*72}", flush=True)
